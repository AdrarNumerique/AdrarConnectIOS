...
let Rouge = UIColor(red: 242/255, green: 88/255, blue: 68/255, alpha: 1) // changement
...
let checkBoxVide = UIImage(named: "checkBoxVide")
let checkBoxRemplie = UIImage(named: "checkBoxRemplie")
